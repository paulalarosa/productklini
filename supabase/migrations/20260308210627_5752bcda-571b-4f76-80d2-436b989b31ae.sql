...
-- and scope to 'authenticated' role instead of 'public'
-- =============================================

-- Helper: Drop all existing policies and recreate as PERMISSIVE for authenticated
